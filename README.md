...
If you do not have patience to read, you can either directly jump to the [Quick Start] section for example code, or go to the [How-To](https://github.com/ryanrhymes/panns/wiki/How-To) page.
