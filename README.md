...
**Note: the new version of panns stopped storing the actual random vector in the index to achieve smaller file size. This also means it will not work on the old panns index file. If you still want to use the older version, check 0.1.8 tag or vector branch.**
